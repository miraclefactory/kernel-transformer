...
df2 = pd.read_csv('/Users/yuelin_xin/Downloads/kt_log (3).csv', header=None)

# give columns appropriate names
df.columns = ['Epoch', 'Accuracy', 'Loss']
df1.columns = ['Epoch', 'Train Acc.', 'Accuracy', 'Loss']
df2.columns = ['Epoch', 'Train Acc.', 'Accuracy', 'Loss']

# print max accuracy
print(f'Max Accuracy: {df2["Accuracy"].max()}')
...
plt.plot(df2['Epoch'], df2['Accuracy'], label='Val. Accuracy')
